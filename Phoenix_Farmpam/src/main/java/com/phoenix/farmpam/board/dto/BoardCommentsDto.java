...
public class BoardCommentsDto {
	...
	public BoardCommentsDto(int comments_idx, String comments_writer, String comments_content,
			String comments_target_id, int comments_ref_group, int comments_group, String comments_deleted,
			String comments_ban, String comments_regdate, int startRowNum, int endRowNum) {
		super();
